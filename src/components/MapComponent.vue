<template>
  <div class="map-container">
    <gmap-map class="map" :center="coordinates[currentLocation.place]" :zoom="currentLocation.zoomLevel" :options="{styles: mapStyles}" >
  ...
  export default {
    ...
    data() {
      return {
        ...
        polylines: {
          provingGroundsOptions: {
            path: MapData.coordinates.provingGroundsLoop,
            strokeColor: '#FF0000',
            strokeOpacity: 1.0,
            strokeWeight: 2,
            icons: []
          ...
          hfeOptions: {
            path: MapData.coordinates.hfeStretch,
            strokeColor: '#FF0000',
            strokeOpacity: 1.0,
            strokeWeight: 2,
            icons: []
